  ...
  return (
    <>
      ...
      <div className="flex flex-col items-center gap-6 mt-12 relative z-10 px-4 mb-20">
          ...
          {categories.map((cat) => {
            ...
            return (
              <Link
                ...
                className={`px-6 py-2 rounded-full text-[10px] font-bold tracking-[0.2em] border transition-all duration-500 uppercase ${
                  isActive
        ...
        <div className="flex gap-4 p-1 glass rounded-full overflow-hidden border border-white/5">
          {["all", "free", "paid"].map((type) => {
            ...
            return (
              <Link
                ...
                className={`px-8 py-2 rounded-full text-[10px] font-bold tracking-[0.2em] transition-all duration-500 uppercase ${
                  isActive
