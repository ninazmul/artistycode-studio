  ...
  return (
    <div>
      <Sheet open={isOpen} onOpenChange={setIsOpen}>
        ...
        <SheetContent className="bg-black/10 dark:bg-black/10 backdrop-blur-md">
          <SheetHeader>
            ...
            <div className="space-y-4 mt-6">
              <div className="flex flex-col gap-1">
                ...
                <input
                  ...
                  className="px-4 py-2 rounded-lg border border-gray-300 bg-black text-white placeholder:text-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
      ...
      <Dialog open={showSuccessModal} onOpenChange={setShowSuccessModal}>
        <DialogContent className="bg-black/90 border border-white/10 backdrop-blur-md text-white">
          <DialogHeader>
